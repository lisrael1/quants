...
# cat ../cluster_run_101_snr_swip.sh|sed 's/snr="\[100/snr="[500/'|grep -v ml_map
...
sbatch --dependency=singleton --wrap 'date|mutt -s done israelilior@gmail.com'
