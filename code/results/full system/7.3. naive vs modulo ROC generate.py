...
if __name__ == '__main__':
    ...
    parser.add_option("-s", "", dest="simulations", type="int", default=100, help='number of simulations, for example 50. you better use 400')
    ...
    quant_size=np.linspace(eval(u.quant_size_range)[0],eval(u.quant_size_range)[1],20)[1:]
    std_threshold=np.linspace(eval(u.std_threshold_range)[0],eval(u.std_threshold_range)[1],20)
