...
if __name__ == '__main__':
    ...
    parser.add_option("-s", "", dest="simulations", type="int", default=20000, help='number of simulations, for example 50. you better use 400 [default: %default]') # about 8360 sims per unit here
    # parser.add_option("-b", "", dest="number_of_bins_range", type="str", default='[3,25]', help='number of bins, for example [3,25]')
    parser.add_option("-b", "", dest="number_of_bins_range", type="str", default='[23,25]', help='number of bins, for example [3,25] [default: %default]')
    # parser.add_option("-q", "", dest="quant_size_range", type="str", default='[0,2]', help='number of bins, for example [0,2]')
    parser.add_option("-q", "", dest="quant_size_range", type="str", default='[0,0.9]', help='number of bins, for example [0,2] [default: %default]')
    number_of_quant_size=20
