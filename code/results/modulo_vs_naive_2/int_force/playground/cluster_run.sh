...
sbatch --mem=1800m -c1 --time=23:50:0 --array=0-1 --wrap 'python3 flow_cross_methods.py -s ${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID} --methods="[\"basic_method\"]" -q "[0,0.5,150]" -b "[101,511]" --snr="[100000]" -m 1'
sbatch --mem=1800m -c1 --time=23:50:0 --array=0-499 --wrap 'python3 flow_cross_methods.py -s ${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID} --methods="[\"clipping_method\"]" -q "[0,0.5,150]" -b "[101,511]" --snr="[100000]" -m 2'
sbatch --mem=1800m -c1 --time=23:50:0 --array=0-499 --wrap 'python3 flow_cross_methods.py -s ${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID} --methods="[\"sinogram_method\"]" -q "[0,0.5,150]" -b "[101,511]" --snr="[100000]" -m 2'
