'''
	after having a lot of gz files, this will create few graphs from all those files
	to get those files, you need to run "cluster_run.sh" at hebrew university cluster (slurm cluster)
	this sh file runs flow_cross_methods.py script multiple times for different methods and different quantizer size and number of bins,
	and each case outputs gz file (something like results_del_7131018_111.csv.gz)
'''
import pandas as pd
import numpy as np
